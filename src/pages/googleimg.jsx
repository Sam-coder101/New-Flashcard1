...
const GoogleImageSearch = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center bg-gradient-to-br from-gray-900 via-purple-900 to-black text-white p-6 pt-50">
            <h1 className="text-3xl font-bold text-center mt-15 ">🔍 Google Image Search</h1>
            <div className="flex flex-col sm:flex-row gap-2 mt-4 w-full max-w-lg pl-20">
                <input
                    type="text"
                    value={query}
